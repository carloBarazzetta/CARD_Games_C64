...
;D:\DEV\CardGamesC64\CARD_Games_C64\Dev\Test\start-test.prg ==0801==
   10 rem start test clipping
   15 print chr$(147);
   ...
   40 print"load";chr$(34);"card routines 2";chr$(34);",8,1"
   45 print chr$(17);chr$(17);chr$(17);chr$(17);
   50 print"new"
   52 print chr$(17);chr$(17);
   55 print"load";chr$(34);"test clipping";chr$(34);",8"
